...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0D6EFD);
  late Color secondary = const Color(0xFF1483C2);
  late Color tertiary = const Color(0xFFFF4C24);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFFECECEC);
  late Color secondaryText = const Color(0xFF707B81);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF6A6A6A);
